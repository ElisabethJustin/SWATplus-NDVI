    ...
    !! RESERVOIR
      if (pco%res%d == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2540,*) ch_wbod_hdr, 'area_ha   ', 'precip    ','evap     ','seep     ',hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr !!EB
     ...
     if (pco%res%m == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2541,*) ch_wbod_hdr, 'area_ha   ', 'precip    ','evap     ','seep     ', hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
     ...
     if (pco%res%y == "y" .and. sp_ob%res > 0 ) then
        ...
        write (2542,*) ch_wbod_hdr, 'area_ha   ', 'precip    ','evap     ','seep     ',hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
      ...
      if (pco%res%a == "y" .and. sp_ob%res > 0) then
        ...
        write (2543,*) ch_wbod_hdr, 'area_ha   ', 'precip    ','evap     ','seep     ',hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
