      ...
      if (cont==.false.) then
        ...
        !specific plant growing  EB : le cas ou une seule plante par HRU peut pousser
        case ("plant_ete_uniq")   !!EB condition pour planter : que la culture soit celle prévue par la rotation (idem "option" mais plus tôt dans les calculs=> économies de temps)
          ob_num = ob_cur
        ...
        case ("plant_hiver_uniq")   !!EB condition pour planter : que la culture soit celle prévue par la rotation (idem "option" mais plus tôt dans les calculs=> économies de temps)
          ob_num = ob_cur
