...
!!EB commente      
      type output_waterbal_header
        ...
        character (len=3) :: mo          =  "mo "
        character (len=3) :: day_mo      =  "da "
        ...
        !!!character (len=10) :: surq_gen   =  "  surq_gen"      
        !!!character (len=10) :: latq       =  "      latq" 
        !!character (len=12) :: wateryld   =  "    wateryld"
        !!!character (len=10) :: perc       =  "      perc"   
        character (len=6) :: et         =  "    et"
        !!character (len=12) :: tloss      =  "       tloss"
        character (len=6) :: eplant     =  "  eplt"
        character (len=6) :: esoil      =  " esoil"
        ...
        !!!character (len=10) :: sw_ave     =  "    sw_ave"
        !!!character (len=10) :: sw_300     =  "    sw_300"
        !!character (len=12) :: sno_init   =  "    sno_init"
        !!character (len=12) :: sno_final  =  "   sno_final"
        !!character (len=12) :: snopack    =  "     snopack"   
        character (len=6) :: pet        =  "   pet"
        !!character (len=12) :: qtile      =  "       qtile"
        character (len=6) :: irr        =  "   irr"
        !!!character (len=10) :: surq_runon =  " surq_runo"
        !!!character (len=10) :: latq_runon =  " latq_runo"
      ...
      type output_waterbal_header_units
        ...
        !!!character (len=10) :: surq_gen   =  "        mm"      
        !!!character (len=10) :: latq       =  "        mm" 
        !!character (len=12) :: wateryld   =  "          mm"
        !!!character (len=10) :: perc       =  "        mm"   
        character (len=10) :: et         =  "        mm"
        !!character (len=12) :: tloss      =  "          mm"
        character (len=10) :: eplant     =  "        mm"
        character (len=10) :: esoil      =  "        mm"
        !!character (len=12) :: surq_cont  =  "          mm"
        !!character (len=12) :: cn         =  "         ---"
        !!character (len=12) :: sw_init    =  "          mm"
        !!character (len=12) :: sw_final   =  "          mm"
        !!!character (len=10) :: sw_ave     =  "        mm"
        !!!character (len=10) :: sw_300     =  "        mm"
        !!character (len=12) :: sno_init   =  "          mm"
        !!character (len=12) :: sno_final  =  "          mm"
        !!character (len=12) :: snopack    =  "          mm"  
        character (len=10) :: pet        =  "        mm"
        !!character (len=12) :: qtile      =  "          mm"
        character (len=10) :: irr        =  "        mm"
        !!!character (len=10) :: surq_runon =  "        mm"
        !!!character (len=10) :: latq_runon =  "        mm"
...
!!EB avec 1 : affichage entier      
      type output_waterbal_header1
        character (len=5) :: day         =  " jday"
        ...
        character (len=10) :: precip     =  "    precip"
        character (len=10) :: snofall    =  "   snofall"
        character (len=10) :: snomlt     =  "    snomlt"        
        character (len=10) :: surq_gen   =  "  surq_gen"      
        character (len=10) :: latq       =  "      latq" 
        character (len=10) :: wateryld   =  "  wateryld"
        character (len=10) :: perc       =  "      perc"   
        character (len=10) :: et         =  "        et"
        character (len=10) :: tloss      =  "     tloss"
        character (len=10) :: eplant     =  "    eplant"
        character (len=10) :: esoil      =  "     esoil"
        character (len=10) :: surq_cont  =  " surq_cont"
        character (len=10) :: cn         =  "        cn"
        character (len=10) :: sw_init    =  "   sw_init"
        character (len=10) :: sw_final   =  "  sw_final"
        character (len=10) :: sw_ave     =  "    sw_ave"
        character (len=10) :: sw_300     =  "    sw_300"
        character (len=10) :: sno_init   =  "  sno_init"
        character (len=10) :: sno_final  =  " sno_final"
        character (len=10) :: snopack    =  "   snopack"   
        character (len=10) :: pet        =  "       pet"
        character (len=10) :: qtile      =  "     qtile"
        character (len=10) :: irr        =  "       irr"
        character (len=10) :: surq_runon =  " surq_runo"
        character (len=10) :: latq_runon =  " latq_runo"
        character (len=10) :: overbank   =  "  overbank"
        character (len=10) :: surq_cha   =  "  surq_cha"
        character (len=10) :: surq_res   =  "  surq_res"
        character (len=10) :: surq_ls    =  "   surq_ls"
        character (len=10) :: latq_cha   =  "  latq_cha"
        character (len=10) :: latq_res   =  "  latq_res"
        character (len=10) :: latq_ls    =  "   latq_ls"
      end type output_waterbal_header1      
      type (output_waterbal_header1) :: wb_hdr1
      
      type output_waterbal_header_units1
        character (len=5) :: day         =  "     "
        character (len=6) :: mo          =  "      "
        character (len=6) :: day_mo      =  "      "
        character (len=6) :: yrc         =  "      "
        ...
        character (len=8) :: id          =  "        "        
        character (len=16) :: name       =  "                "        
        character (len=10) :: precip     =  "        mm"
        character (len=10) :: snofall    =  "        mm"
        character (len=10) :: snomlt     =  "        mm"        
        character (len=10) :: surq_gen   =  "        mm"      
        character (len=10) :: latq       =  "        mm" 
        character (len=10) :: wateryld   =  "        mm"
        character (len=10) :: perc       =  "        mm"   
        character (len=10) :: et         =  "        mm"
        character (len=10) :: tloss      =  "        mm"
        character (len=10) :: eplant     =  "        mm"
        character (len=10) :: esoil      =  "        mm"
        character (len=10) :: surq_cont  =  "        mm"
        character (len=10) :: cn         =  "       ---"
        character (len=10) :: sw_init    =  "        mm"
        character (len=10) :: sw_final   =  "        mm"
        character (len=10) :: sw_ave     =  "        mm"
        character (len=10) :: sw_300     =  "        mm"
        character (len=10) :: sno_init   =  "        mm"
        character (len=10) :: sno_final  =  "        mm"
        character (len=10) :: snopack    =  "        mm"  
        character (len=10) :: pet        =  "        mm"
        character (len=10) :: qtile      =  "        mm"
        character (len=10) :: irr        =  "        mm"
        character (len=10) :: surq_runon =  "        mm"
        character (len=10) :: latq_runon =  "        mm"
        character (len=10) :: overbank   =  "        mm"
        character (len=10) :: surq_cha   =  "        mm"
        character (len=10) :: surq_res   =  "        mm"
        character (len=10) :: surq_ls    =  "        mm"
        character (len=10) :: latq_cha   =  "        mm"
        character (len=10) :: latq_res   =  "        mm"
        character (len=10) :: latq_ls    =  "        mm"
      end type output_waterbal_header_units1      
      type (output_waterbal_header_units1) :: wb_hdr_units1
...
!!EB commente     
      type output_plantweather_header
        ...
        !!character (len=8) :: id         =  " gis_id "        
        character (len=10) :: name      =  " name     "        
        character (len=6) :: lai       =  "   lai"
        !!!character (len=10) :: bioms     =  "     bioms"
        !!!character (len=10) :: yield     =  "     yield"
        !!!character (len=10) :: residue   =  "   residue"
        !!!character (len=10) :: sol_tmp   =  "   sol_tmp"
        character (len=6) :: strsw     =  " strsw"
      ...
      type output_plantweather_header_units
        ...
        !!character (len=8) :: id         =  "        "        
        character (len=16) :: name      =  "                   " 
        character (len=10) :: lai       =  "  m**2/m**2"
        !!!character (len=10) :: bioms     =  "      kgha"
        !!!character (len=10) :: yield     =  "      kgha"
        !!!character (len=10) :: residue   =  "      kgha"
        !!!character (len=10) :: sol_tmp   =  "      degc"
        character (len=10) :: strsw     =  "       ----"
        ...
        character (len=10) :: phubase0  =  "      degc"
