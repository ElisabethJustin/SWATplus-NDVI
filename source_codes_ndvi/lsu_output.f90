      ...
      do ilsu = 1, db_mx%lsu_out
        ...
        !! daily print - LANDSCAPE UNIT
         if (pco%day_print == "y" .and. pco%int_day_cur == pco%int_day) then
          if (pco%wb_lsu%d == "y") then
            ...
            write (2140,100) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, ruwb_d(ilsu)%et, ruwb_d(ilsu)%eplant, ruwb_d(ilsu)%esoil, ruwb_d(ilsu)%pet, ruwb_d(ilsu)%irr  !! waterbal !!EB
          ...
          if (pco%pw_lsu%d == "y") then
            write (2170,100) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, rupw_d(ilsu)%lai, rupw_d(ilsu)%strsw, rupw_d(ilsu)%phubase0  !! plant weather !!EB
            if (pco%csvout == "y") then 
        ...
        if (time%end_mo == 1) then
          ...
          if (pco%wb_lsu%m == "y") then
            ...
            write (2141,100) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, ruwb_m(ilsu)%et, ruwb_m(ilsu)%eplant, ruwb_m(ilsu)%esoil, ruwb_m(ilsu)%pet, ruwb_m(ilsu)%irr !!EB
            if (pco%csvout == "y") then 
          ...
          if (pco%pw_lsu%m == "y") then
            write (2171,100) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, rupw_m(ilsu)%lai, rupw_m(ilsu)%strsw, rupw_m(ilsu)%phubase0  !!EB
            if (pco%csvout == "y") then 
              write (2175,'(*(G0.3,:","))') time%day, time%mo, time%day_mo, time%yrc, &
        ...
        if (time%end_yr == 1) then
           ...
           if (pco%wb_lsu%y == "y") then
             ...
             write (2142,102) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, ruwb_y(ilsu)%et, ruwb_y(ilsu)%eplant, ruwb_y(ilsu)%esoil, ruwb_y(ilsu)%pet,  ruwb_y(ilsu)%irr !!EB
             if (pco%csvout == "y") then 
           ...
           if (pco%pw_lsu%y == "y") then
             write (2172,102) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, rupw_y(ilsu)%lai, rupw_y(ilsu)%strsw, rupw_y(ilsu)%phubase0  !!EB
             if (pco%csvout == "y") then 
      ...
      if (time%end_sim == 1 .and. pco%wb_lsu%a == "y") then
        ...
        write (2143,102) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, ruwb_a(ilsu)%et, ruwb_a(ilsu)%eplant, ruwb_a(ilsu)%esoil, ruwb_a(ilsu)%pet, ruwb_a(ilsu)%irr  !!EB
        if (pco%csvout == "y") then 
      ...
      if (time%end_sim == 1 .and. pco%pw_lsu%a == "y") then    
        ...
        write (2173,102) time%mo, time%day_mo, time%yrc, lsu_out(ilsu)%name, rupw_a(ilsu)%lai, rupw_a(ilsu)%strsw, rupw_a(ilsu)%phubase0  !!EB
        if (pco%csvout == "y") then 
...
102   format (2i3,i5,1x,a10,3f6.3)
