...
!!!  SWAT-DEG CHANNEL
      if (sp_ob%chandeg > 0) then
        if (pco%sd_chan%d == "y") then
          ...
          !!EB write (2500,*) ch_wbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr, wtmp_hdr
          !!EB write (2500,*) ch_wbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1, wtmp_units 
          write (2500,*) ch_wbod_hdr, hyd_out_hdr, hyd_stor_hdr
          write (2500,*) ch_wbod_hdr_units, hyd_hdr_units1
        ...
        if (sp_ob%chandeg > 0) then
          ...
          write (2501,*) ch_wbod_hdr, hyd_out_hdr
          write (2501,*) ch_wbod_hdr_units, hyd_hdr_units1
      ...
      if (sp_ob%chandeg > 0) then
        if (pco%sd_chan%y == "y") then
          ...
          write (2502,*) ch_wbod_hdr, hyd_out_hdr
          write (2502,*) ch_wbod_hdr_units, hyd_hdr_units1
        ...
        if (sp_ob%chandeg > 0) then
          ...
          write (2503,*) ch_wbod_hdr, hyd_out_hdr
          write (2503,*) ch_wbod_hdr_units, hyd_hdr_units1
