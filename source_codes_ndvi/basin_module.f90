      ...
      type print_interval2
        character(len=1) :: d = "n"
        character(len=1) :: m = "n"
        character(len=1) :: y = "n"
        character(len=1) :: a = "n"
        integer :: nb_print = 0                 !!EB pour affichage leger
        integer, dimension(:), allocatable :: list_print   !!EB pour affichage leger
      end type print_interval2
      ...
      ! REGION
       ...
       ! LSU
        ...
        ! CHANNEL_LTE
        type(print_interval2) :: sd_chan         !!  swat deg (lte) channel output
        ! AQUIFER
