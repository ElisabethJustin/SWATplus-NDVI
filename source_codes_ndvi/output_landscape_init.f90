...
!!!  BASIN - Water balance 
      if (time%step == 0) then
        if (pco%wb_bsn%d == "y") then
          ...
          write (2050,*) wb_hdr1  !! bsn
          write (2050,*) wb_hdr_units1
       ...
       if (pco%wb_bsn%m == "y") then 
        ...
        write (2051,*) wb_hdr1  !! bsn !!EB avec 1 = affichage entier
        write (2051,*) wb_hdr_units1
      ...
      if (time%step == 0) then
        if (pco%wb_bsn%y == "y") then
          ...
          write (2052,*) wb_hdr1  !! bsn
          write (2052,*) wb_hdr_units1
       ...
       if (pco%wb_bsn%a == "y") then 
        ...
        write (2053,*) wb_hdr1  !! bsn
        write (2053,*) wb_hdr_units1
