      ...
      type hru_databases_char
        ...
        character(len=50) :: soil = ""  !!EB 50 (remplace 20)
...
!!EBndvi deb
      type ndvi_hru
        real, dimension(37) :: val = 0.    !! une valeur de NDVI tous les 10 jours
        integer :: jdeb = 1                 !! numero du premier jour de la serie (jour julien)
        integer :: jfin = 365               !! numero du dernier jour de la serie (jour julien)
        logical :: util = .false.           !! true si on utilise le NDVI pour calculer ETR, false sinon
        real :: ndvi_j = 0.                 !! le ndvi du jour courant
        real :: maxndvi = 0.                !! le ndvi max sur l annee
        integer :: evol = 0                 !! 1 si en train d'augmenter, 2 si en train de diminuer, 0 sinon
      end type ndvi_hru
!!EBndvi fin
      ...
      type hydrologic_response_unit
        ...
        type (ndvi_hru) :: ndvi     !! EBndvi  valeurs mises a jour chaque annee
        integer :: cur_op = 1
