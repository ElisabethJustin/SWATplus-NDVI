      ...
      character(len=4), dimension (:), allocatable :: plts_bsn     !none      |plant names simulated in current run !!EB change len=4 au lieu de len=16 (pb dans plant_all_init)
      character(len=4), dimension (:), allocatable :: plants_bsn   !none      |plant names simulated in current run - final !!EB change len=4 au lieu de len=16 (pb dans plant_all_init)
